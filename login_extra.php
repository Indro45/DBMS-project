...
if (isset($_POST['submit'])) {
 /* echo "<pre>";
  ...
  $sql = mysqli_query($conn,"select * from news_user where email='$email' && password='$password'");
...
<body background="photo/background.jpeg" >
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img style="height:40rem; border-radius: 1rem; " src="photo/loginimg.jpeg"
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form method="post" action="">
                  ...
                  <div class="pt-1 mb-4">
                    ...
                    <p>Are you a new user?<a href="signup.php">Signup here</a></p>
                  </div>
                </form>
              </div>
            </div>
